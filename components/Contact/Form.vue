<template>
    ...
    <div  >
        <div class="mb-3">
            ...
            <InputText type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                v-model="model.name" :invalid="!isRequiredName(model.name)"/>
            <div id="emailHelp" class="form-text" v-if="!isRequiredName(model.name)">{{ form.field_1 }}</div>
            <div id="emailHelp" class="form-text" v-if="isRequiredName(model.name)" style="height:20px;"></div>

        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">{{ form.email }}</label>
            <InputText  name="field"  type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                v-model="model.email" :invalid="!isRequiredMail(model.email)" />
            <div id="emailHelp" class="form-text" v-if="!isRequiredMail(model.email)">{{ form.field_2 }}</div>
            <div id="emailHelp" class="form-text" v-if="isRequiredMail(model.email)" style="height:20px;"></div>
