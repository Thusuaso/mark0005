    ...
    <div class="row m-auto">
      <div class="col-sm-4">
        ...
        <ul class="row m-auto text-center">
          <li
            class="col-2"
            v-for="social of footer.about.socials"
      ...
      <div class="col-sm-4">
        ...
        <div class="personalContainer" style="margin-bottom: 35px">
          <div class="personalContainerLimited">
            <div class="personalCardGrid">
              <div class="personalCardColumnOne">
                <img
                  :src="footer.personal.items[0].image"
                  :alt="footer.personal.items[0].name + '-mekmar'"
                />
              </div>
              <div class="personalCardColumnTwo">
                <div>{{ footer.personal.items[0].name }}</div>
                <div>{{ footer.personal.items[0].job }}</div>
                <div>
                  <a
                    :href="'mailto:' + footer.personal.items[0].email"
                    class="text-decoration-none text-body-emphasis"
                  >
                    <i class="fa fa-envelope" style="color: white"></i>
                    <span class="footer-span">{{
                      footer.personal.items[0].email
                    }}</span>
                  </a>
                </div>
                <div>
                  <a
                    :href="'mailto:' + footer.personal.items[0].email2"
                    class="text-decoration-none text-body-emphasis"
                  >
                    <i class="fa fa-envelope" style="color: white"></i>
                    <span class="footer-span">{{
                      footer.personal.items[0].email2
                    }}</span>
                  </a>
                </div>
                <div>
                  <a
                    target="_blank"
                    :href="footer.personal.items[0].watsappLink"
                    class="text-decoration-none"
                  >
                    <i class="fa fa-whatsapp" style="color: white"></i>
                    <span class="footer-span">{{
                      footer.personal.items[0].whatsapp
                    }}</span>
                  </a>
                </div>
              </div>
        ...
        <div class="personalContainer">
          <div class="personalContainerLimited">
            <div class="personalCardGrid">
              <div class="personalCardColumnOne">
                <img
                  :src="footer.personal.items[1].image"
                  :alt="footer.personal.items[1].name + '-mekmar'"
                />
              </div>
              <div class="personalCardColumnTwo">
                <div>{{ footer.personal.items[1].name }}</div>
                <div>{{ footer.personal.items[1].job }}</div>
                <div>
                  <a
                    :href="'mailto:' + footer.personal.items[1].email"
                    class="text-decoration-none text-body-emphasis"
                  >
                    <i class="fa fa-envelope" style="color: white"></i>
                    <span class="footer-span">{{
                      footer.personal.items[1].email
                    }}</span>
                  </a>
                </div>
                ...
                <div>
                  <a
                    target="_blank"
                    :href="footer.personal.items[1].watsappLink"
                    class="text-decoration-none"
                  >
                    <i class="fa fa-whatsapp" style="color: white"></i>
                    <span class="footer-span">{{
                      footer.personal.items[1].whatsapp
                    }}</span>
                  </a>
                </div>
              </div>
