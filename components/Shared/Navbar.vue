<template>
  ...
  <div class=" container row m-auto text-center" v-if="selectedLang.status == 'en' ">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        <li class="nav-item custom_navbar_css_en" >
          <NuxtLink class="nav-link custom_navbar_css_font_en" style="font-weight: bold;" tag="a" :to="navbar_link.home">{{ navbar.home }}</NuxtLink>
        </li>

        <li class="nav-item dropdown custom_navbar_css_en" style="margin-right:5px;">
        ...
        <li class="nav-item custom_navbar_css_en">
          <NuxtLink class="nav-link custom_navbar_css_font_en" style="font-weight: bold;" tag="a" :to="navbar_link.fabrication">{{ navbar.fabrication}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_en">
          <NuxtLink class="nav-link custom_navbar_css_font_en" style="font-weight: bold;" tag="a" :to="navbar_link.videos">{{ navbar.videos}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_en">
          <NuxtLink class="nav-link custom_navbar_css_font_en" style="font-weight: bold;" tag="a" :to="navbar_link.project">{{ navbar.project}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_en">
  ...
  <div class=" container row m-auto text-center" v-if=" selectedLang.status == 'fr'">
    <div class="col-sm-3 fs-1 text-decoration-none fw-light" >
      <NuxtLink class="text-decoration-none fw-light" :to="selectedLang.link" style="color:#1357bc;">
        <img class="logo_mekmar" src="https://cdn.mekmarimage.com/logo/Mekmar-Logo-b%C3%BCy%C3%BCk-yaz%C4%B1l%C4%B1-01.webp" alt="mekmar-logo"/>
      </NuxtLink>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        <li class="nav-item custom_navbar_css_fr" >
          <NuxtLink class="nav-link custom_navbar_css_font_fr" style="font-weight: bold;" tag="a" :to="navbar_link.home">{{ navbar.home }}</NuxtLink>
        </li>

        <li class="nav-item dropdown custom_navbar_css_fr" style="margin-right:5px;">
          <a class="nav-link dropdown-toggle custom_navbar_css_font_fr" style="font-weight: bold;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            {{ navbar.product }}
          </a>
        ...
        <li class="nav-item custom_navbar_css_fr">
          <NuxtLink class="nav-link custom_navbar_css_font_fr" style="font-weight: bold;" tag="a" :to="navbar_link.fabrication">{{ navbar.fabrication}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_fr">
          <NuxtLink class="nav-link custom_navbar_css_font_fr" style="font-weight: bold;" tag="a" :to="navbar_link.videos">{{ navbar.videos}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_fr">
          <NuxtLink class="nav-link custom_navbar_css_font_fr" style="font-weight: bold;" tag="a" :to="navbar_link.project">{{ navbar.project}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_fr">
          <NuxtLink class="nav-link custom_navbar_css_font_fr" style="font-weight: bold;" tag="a" :to="navbar_link.contact">{{ navbar.contact}}</NuxtLink>
        </li>
        <li class="nav-item dropdown custom_navbar_css_fr">
          <a class="nav-link dropdown-toggle custom_navbar_css_font_fr" style="font-weight: bold;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            {{ navbar.usa }}
  ...
  <div class=" container row m-auto text-center" v-if="selectedLang.status == 'es'">
    <div class="col-sm-3 fs-1 text-decoration-none fw-light" >
      <NuxtLink class="text-decoration-none fw-light" :to="selectedLang.link" style="color:#1357bc;">
        <img class="logo_mekmar" src="https://cdn.mekmarimage.com/logo/Mekmar-Logo-b%C3%BCy%C3%BCk-yaz%C4%B1l%C4%B1-01.webp" alt="mekmar-logo"/>
      </NuxtLink>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        <li class="nav-item custom_navbar_css_es" >
          <NuxtLink class="nav-link custom_navbar_css_font_es" style="font-weight: bold;" tag="a" :to="navbar_link.home">{{ navbar.home }}</NuxtLink>
        </li>

        <li class="nav-item dropdown custom_navbar_css_es" style="margin-right:5px;">
          <a class="nav-link dropdown-toggle custom_navbar_css_font_es" style="font-weight: bold;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            {{ navbar.product }}
          </a>
        ...
        <li class="nav-item custom_navbar_css_es">
          <NuxtLink class="nav-link custom_navbar_css_font_es" style="font-weight: bold;" tag="a" :to="navbar_link.fabrication">{{ navbar.fabrication}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_es">
          <NuxtLink class="nav-link custom_navbar_css_font_es" style="font-weight: bold;" tag="a" :to="navbar_link.videos">{{ navbar.videos}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_es">
          <NuxtLink class="nav-link custom_navbar_css_font_es" style="font-weight: bold;" tag="a" :to="navbar_link.project">{{ navbar.project}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_es">
  ...
  <div class=" container row m-auto text-center" v-if="selectedLang.status == 'ru'">
    <div class="col-sm-3 fs-1 text-decoration-none fw-light" >
      <NuxtLink class="text-decoration-none fw-light" :to="selectedLang.link" style="color:#1357bc;">
        <img class="logo_mekmar" src="https://cdn.mekmarimage.com/logo/Mekmar-Logo-b%C3%BCy%C3%BCk-yaz%C4%B1l%C4%B1-01.webp" alt="mekmar-logo"/>
      </NuxtLink>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        <li class="nav-item custom_navbar_css_ru" >
          <NuxtLink class="nav-link custom_navbar_css_font_ru" style="font-weight: bold;" tag="a" :to="navbar_link.home">{{ navbar.home }}</NuxtLink>
        </li>

        <li class="nav-item dropdown custom_navbar_css_ru" style="margin-right:5px;">
          <a class="nav-link dropdown-toggle custom_navbar_css_font_ru" style="font-weight: bold;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            {{ navbar.product }}
          </a>
        ...
        <li class="nav-item custom_navbar_css_ru">
          <NuxtLink class="nav-link custom_navbar_css_font_ru" style="font-weight: bold;" tag="a" :to="navbar_link.fabrication">{{ navbar.fabrication}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_ru">
          <NuxtLink class="nav-link custom_navbar_css_font_ru" style="font-weight: bold;" tag="a" :to="navbar_link.videos">{{ navbar.videos}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_ru">
          <NuxtLink class="nav-link custom_navbar_css_font_ru" style="font-weight: bold;" tag="a" :to="navbar_link.project">{{ navbar.project}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_ru">
  ...
  <div class=" container row m-auto text-center" v-if="selectedLang.status == 'ar'">
    <div class="col-sm-3 fs-1 text-decoration-none fw-light" >
      <NuxtLink class="text-decoration-none fw-light" :to="selectedLang.link" style="color:#1357bc;">
        <img class="logo_mekmar" src="https://cdn.mekmarimage.com/logo/Mekmar-Logo-b%C3%BCy%C3%BCk-yaz%C4%B1l%C4%B1-01.webp" alt="mekmar-logo"/>
      </NuxtLink>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        <li class="nav-item custom_navbar_css_ar" >
          <NuxtLink class="nav-link custom_navbar_css_font_ar" style="font-weight: bold;" tag="a" :to="navbar_link.home">{{ navbar.home }}</NuxtLink>
        </li>

        <li class="nav-item dropdown custom_navbar_css_ar" style="margin-right:5px;">
          <a class="nav-link dropdown-toggle custom_navbar_css_font_ar" style="font-weight: bold;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            {{ navbar.product }}
          </a>
        ...
        <li class="nav-item custom_navbar_css_ar">
          <NuxtLink class="nav-link custom_navbar_css_font_ar" style="font-weight: bold;" tag="a" :to="navbar_link.fabrication">{{ navbar.fabrication}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_ar">
          <NuxtLink class="nav-link custom_navbar_css_font_ar" style="font-weight: bold;" tag="a" :to="navbar_link.videos">{{ navbar.videos}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_ar">
          <NuxtLink class="nav-link custom_navbar_css_font_ar" style="font-weight: bold;" tag="a" :to="navbar_link.project">{{ navbar.project}}</NuxtLink>
        </li>
        <li class="nav-item custom_navbar_css_ar">
