    ...
    <div class="row m-auto text-center">
        <div class="col-sm-3">
            ...
            <div class="container border mb-3"
                ...
                <h3 class="header mt-3">FINISH</h3>
            ...
            <div class="container border mb-3" v-if="category_id == 4 || category_id == 7">
                <h3 class="header mt-3">MATERIAL</h3>
...
await $fetch('/api/products/filter/' + router.currentRoute._value.params.categoryId + '/material/' + router.currentRoute._value.params.materialId)
    .then(res => {
