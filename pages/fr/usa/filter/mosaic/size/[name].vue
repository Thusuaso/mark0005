...
const mosaicFilter = await $fetch(
  "/api/usa/filter/mosaic/" + router.currentRoute._value.params.name
);
const products = control.lang_usa_product(mosaicFilter.products, store.getLang);
const categories = mosaicFilter.category;
const colors = control.lang_usa_filter(mosaicFilter.color, store.getLang);
const sizes = mosaicFilter.size;
const usages = control.lang_usa_filter(mosaicFilter.usage, store.getLang);
const mosaics = mosaicFilter.mosaic;
