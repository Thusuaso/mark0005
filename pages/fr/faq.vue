<template>
    <div class="container row m-auto">
        ...
        <h5 class="subheader_faq "><b>Q: Quelles sont les principales différences entre le travertin, le marbre et le calcaire ?</b></h5>
        <ul class="description_font" style="margin:0px;">
            <li><b>Travertin</b>: Connu pour ses trous et pores naturels, il offre un aspect rustique.</li>
            <li><b>Marbre</b>: Poli et élégant, comportant souvent des veines et une finition brillante.</li>
            <li><b>Calcaire</b>: Plus doux avec une finition mate, offrant une apparence plus naturelle et plus discrète.</li>
        </ul>
        ...
        <h5 class="subheader_faq"><b>Q: Comment nettoyer et entretenir ces carreaux ?</b></h5>
            <ul class="description_font" style="margin:0px;">
                ...
                <li>Évitez les nettoyants acides ou abrasifs car ils peuvent endommager la pierre.</li>
        ...
        <h5 class="subheader_faq"><b>Q: Quelles sont les options de couleurs disponibles ?</b></h5>
            <ul class="description_font" style="margin:0px;">
                ...
                <li><b>Marbre:</b> Blancs classiques, gris, noirs et parfois verts ou rouges.</li>
        ...
        <ul class="description_font" style="margin:0px;">
                <h5 class="subheader_faq"><b>Q: Quel type de carrelage convient le mieux à une utilisation en extérieur ?</b></h5>
                    <ul class="description_font_2" style="margin:0px;">
                        <li>
                            <b>Travertin: </b>Parfait pour les patios et les plages de piscine grâce à sa surface antidérapante.
                        </li>
                        <li>
        ...
        <ul style="margin:0px;" class="description_font">
                ...
                <ul class="description_font_2" style="margin:0px;">
                    ...
                    <li>
                        Esthétique intemporelle et naturelle.
                    </li>
                    <li>
