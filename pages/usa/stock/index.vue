...
// const usa = await useFetch('/api/usa/main');

const usa = await $fetch("/api/usa/main");
const products = control.lang_usa_product(usa.products, store.getLang);
const categories = usa.category;
const colors = control.lang_usa_filter(usa.color, store.getLang);
const sizes = usa.size;
const usages = control.lang_usa_filter(usa.usage, store.getLang);
const mosaics = usa.mosaic;
