...
const colorFilter = await $fetch(
  "/api/usa/filter/color/" + router.currentRoute._value.params.name
);
const products = control.lang_usa_product(colorFilter.products, store.getLang);
const categories = colorFilter.category;
const colors = control.lang_usa_filter(colorFilter.color, store.getLang);
const sizes = colorFilter.size;
const usages = control.lang_usa_filter(colorFilter.usage, store.getLang);
const mosaics = colorFilter.mosaic;
