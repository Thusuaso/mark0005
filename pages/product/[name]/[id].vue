<template>
    ...
    <div class="row m-auto text-center " v-if="category_id == 9">
        <div class="col-sm-12">
            ...
            <p class="description" style="text-align: justify;">
                <strong>Natural stone</strong> brings a sense of luxury and timeless beauty to <strong>kitchen</strong> and <strong>bathroom</strong> spaces. Crafted by nature, materials like <strong>travertine</strong>, <strong>marble</strong>, <strong>limestone</strong>, and <strong>granite</strong> offer unmatched durability, elegance, and unique character to any design. Each piece of <strong>natural stone</strong> is a one-of-a-kind work of art, featuring distinct patterns, veins, and textures that add character and sophistication to your <strong>living spaces</strong>. Natural stone products like <strong>sinks</strong>, <strong>countertops</strong>, <strong>mosaics</strong> and <strong>tiles</strong> are built to last and with proper care, they can withstand the rigors of daily use in high-traffic areas like <strong>kitchens</strong> and <strong>bathrooms</strong>. Whether you prefer the <strong>polished</strong> sophistication of <strong>marble</strong>, the <strong>rustic</strong> warmth of <strong>travertine</strong>, or the modern minimalism of <strong>limestone</strong>, natural stone products suit a variety of design styles. You can use <strong>marble</strong>, <strong>travertine</strong> and <strong>limestone sinks</strong>, <strong>shower trays</strong> and even <strong>bathtubs</strong> to elevate your <strong>bath</strong> and <strong>kitchen</strong> areas to have a luxurious <strong>interior design</strong>. You can also add a touch of modernity to your <strong>interior</strong> and <strong>exterior</strong> areas with <strong>marble vanities</strong>, <strong>travertine shower trays</strong> or <strong>limestone vanities</strong>. <strong>Natural stone</strong> transforms <strong>kitchens</strong> and <strong>bathrooms</strong> into stunning, functional spaces that radiate sophistication. Whether you're designing <strong>residential</strong> or <strong>commercial buildings</strong>, <strong>natural stone</strong> is the ultimate choice for creating sophisticated aesthetic in <strong>kitchens</strong> and <strong>bathrooms</strong>.
            </p>
        </div>
    </div>
