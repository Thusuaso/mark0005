...
export default defineEventHandler(async (event) => {
    ...
    const material = getRouterParam(event, 'material');
     const productsSql = `
    ...
    from MekmarCom_Products mp 
        inner join MekmarCom_MateryalFiltered mmf on mmf.UrunId = mp.urunid
    where mp.kategori_id='${category}' and mmf.MateryalId='${material}' and mp.yayinla=1
