<template>
  <div class="row container m-auto text-center" v-show="!isMobile">
    <div class="col-sm-12">
      <a
        class="customBannerA"
        href="https://www.mekmar.com/product/detail/philadelphia-travertine/948"
        v-show="lang == 'en'"
      >
  ...
  <div class="row container m-auto text-center" v-show="!isMobile">
    <div class="col-sm-12">
      <a
        class="customBannerA"
        href="https://www.mekmar.com/fr/product/detail/philadelphia-travertine/948"
        v-show="lang == 'fr'"
      >
  ...
  <div class="row container m-auto text-center" v-show="!isMobile">
    <div class="col-sm-12">
      <a
        class="customBannerA"
        href="https://www.mekmar.com/es/product/detail/philadelphia-travertine/948"
        v-show="lang == 'es'"
      >
        <div class="container customBanner m-auto text-center" style="">
  ...
  <div class="container row m-auto text-center" v-show="!isMobile">
    <div class="col-sm-12">
      <a
        class="customBannerA"
        href="https://www.mekmar.com/ru/product/detail/philadelphia-travertine/948"
        v-show="lang == 'ru'"
      >
        <div class="container customBanner m-auto text-center" style="">
  ...
  <div class="container row m-auto text-center" v-show="!isMobile">
    <div class="col-sm-12">
      <a
        class="customBannerA"
        href="https://www.mekmar.com/ar/product/detail/philadelphia-travertine/948"
        v-show="lang == 'ar'"
      >
        <div class="container customBanner m-auto text-center" style="">
